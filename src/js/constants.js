...
export const paths = {
    ...
    green: greenAsset,
    purple: purpleAsset,
    yellowMini: yellowMiniAsset,
    redMini: redMiniAsset,
    blueMini: blueMiniAsset,
    greenMini: greenMiniAsset,
    purpleMini: purpleMiniAsset,
    plate: plateAsset,
    progressPurple: progressPurpleAsset,
    progressGreen: progressGreenAsset,
    progressBlue: progressBlueAsset,
    progressRed: progressRedAsset,
    progressYellow: progressYellowAsset,
